# FinanzApp mobile: roadmap history

Moved verbatim from [mobile-roadmap.md](mobile-roadmap.md) on 2026-09-25 (Producto 24UX1):
the "Previous delivery" sections of every delivery up to Producto 24B6, the audit and plan
notes that sat between them, and the whole handoff log. Nothing here was reworded or
trimmed; it is historical evidence and technical history, not current product priorities.
The architectural decisions that still bind are in [docs/decisions](decisions/) and in the
living roadmap's "Decisions that still bind" section; the physical checks are in
[mobile-device-checklist.md](mobile-device-checklist.md). Later entries are added at the top
of each part, as before.

## Contents

- [Previous deliveries](#previous-deliveries) (newest first)
- [Handoff log (historical evidence)](#handoff-log-historical-evidence) (newest first)
...
## Mobile README: former test inventory and status chronology (moved 2026-09-25)

Moved verbatim from `apps/mobile/README.md` when it was rewritten for the native-first direction
(Producto 24UX1, PR #54). Nothing below is current guidance: the README now links here. The three
blocks are the delivery chronology that opened the README, the "Accounts and data in this pilot"
section, and the per-Producto test inventory that closed the Verification section.

### Delivery chronology (former opening of the README)
...
### Accounts and data in this pilot (former section)
...
### Test inventory by delivery (former end of Verification)
