...
applies: the web/Capacitor app was retired on 2026-09-25 (Producto 24REP); its last version is
the tag `web-frontend-final`. Everything else below stands, read in the past tense where it
describes the web.
