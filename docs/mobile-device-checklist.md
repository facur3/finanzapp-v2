...
- [ ] Amount field box: with 3, 30, 300, 3.000, 30.000, 300.000, 3.000.000, 3.000.000,50 and 9.999.999.999.999,99 the last digit and the caret are fully visible, nothing is cut on the right, the box widens as a dot appears, and the size only drops for the longest values; insertion and backspace with the caret at the end, before a dot, after a dot and in the middle keep the caret where expected; the same with the keyboard open and closed, in ARS and USD, and at the largest Dynamic Type.
