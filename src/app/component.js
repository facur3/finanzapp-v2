class Component extends DCLogic {
  ...
  completeBackSwipe(){if(this.state.confirm){this.setState({confirm:null,swipeState:'idle',swipeOffset:0});return;}if(this.state.sheet==='assistant')this.stopAssistantListening();const target=this.state.push==='assetDetail'?'investments':null,previous=this.previousNavigation(target);if(!previous){this.setState({swipeState:'idle',swipeOffset:0});return;}this._restoringNavigation=true;this.setState({...previous,swipeState:'idle',swipeOffset:0,navState:'back-settle'});}
  ...
  openAssetCost(){this.setState({ivSub:'assetCost',assetCostAmount:''});}
