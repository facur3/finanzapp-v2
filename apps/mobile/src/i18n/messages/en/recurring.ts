...
export const recurring: Pick<Messages, 'recurring'> = {
  recurring: {
    ...
    list: {
      ...
      emptyDetail: 'Rent, subscriptions, salary or any transaction that repeats. FinanzApp adds it to your transactions once, when it comes due. It doesn’t pay or collect anything.',
    ...
    form: {
      ...
      frequency: 'Frequency',
      nextDate: 'Next date',
      todayNote: 'If the next date is today, FinanzApp adds that transaction when you save. After that it adds each one when it comes due and you open the app, never twice.',
    ...
    history: {
      title: 'Recorded',
      caption: 'Transactions FinanzApp added for this rule; they don’t confirm a bank payment. The next date is an estimate.',
