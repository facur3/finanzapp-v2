...
// Modes:
//   (default)    read the cached sources (i18n/work/currency-sources, ignored by git), check their
//                sha256 against scripts/currency/sources.lock.json, write the outputs
//   --download   fetch the pinned URLs first, then record their sha256, size and date in the lock
//   --check      write nothing; exit 1 when the committed outputs (or their sha256 in the lock) differ
